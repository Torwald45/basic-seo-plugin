...
class BasicSEO_Torwald45_Quick_Edit {
    ...
    public function add_quick_edit_fields($column_name, $post_type) {
        ...
        <fieldset class="inline-edit-col-right basicseo-quick-edit">
		    ...
		    <label class="alignleft">
    			<span class="title"><?php _e('Meta Title', 'basic-seo-torwald45'); ?></span>
    			<span class="input-text-wrap">
        		     <textarea name="basicseo_custom_title"
        ...
        jQuery(document).ready(function($) {
            ...
            inlineEditPost.edit = function(id) {
                ...
                if (post_id > 0) {
                    ...
                    $editRow.find('textarea[name="basicseo_custom_title"]').val(currentTitle);
    ...
    private function validate_quick_edit_data($title, $description) {
        ...
        if (strlen($title) > 255) {
            $errors[] = __('Meta Title is too long (maximum 255 characters)', 'basic-seo-torwald45');
        }
